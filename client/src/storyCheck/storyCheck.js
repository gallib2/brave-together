...
const mock = [
    ...
    { id: 3, category: 1, title: 'פסח האחרון', storyImg: 'https://s3-alpha-sig.figma.com/img/e0a3/df00/82fa5f5578a40b43ca5f5f121a52dc3a?Expires=1617580800&Signature=KYlP3GTFcuZmK8LSLAYhksfXwZWkMBItgU81gW9MmkJpNMSdPXzTHtkpXMT7QqyqJWoE~b0vqVQuapn~naWSXUgHDRzjvUx5Ych3grC4qVpPAvFReftVROhKuruvSRPGHqtaO32C7~WuaCUa~Rq4JXm0y-yabJy9hYOz0KfzGJd6BgxuSkkfefqtdPYBQsAvmqSrtgwX5a5GdBlTE61M9QL7EMphbpkb1XRyxy11d6jiMB4qdEK-qAC-Odhzxt68c77xwcODTcIF3-agXtcU3bWlVZhP8p3wH~c6vEGGXm68txwg0roLNLJxpnt-mVAHQdCvgjOKhq6aFg1sGEpysw__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA' },
        { id: 4, category: 2, title: 'סיפורה של משפחת וינרב ערב ליל הסדר', storyImg: 'https://s3-alpha-sig.figma.com/img/e03c/fc33/a0fb3f4149d3ec5e3bfee87701bbad5a?Expires=1618185600&Signature=CcibLS2Cr~WPIym7D9HsNvQjL1yWjq1jlZ81uhmsQcUxvwqBfk94Sc39l07QOWlrVUUswOzFdgg7Hoc5jzFCJbqUaB8SUvCGMebU5x14nesT2KOrVw1-087gmA4KTcIjHiEi7XzngnvKljOmYLHF153i3Y7Gwvy~vCeywc4ynYlfGfT1RuAHoCbP-y-XpxrKA5uxgf5q8eke-Mx9YPlL80icIgBu0uUbYfmPJLYnQLBzt5N~mhRGUhoFgFS~PzpsLucf6R0aw5eUtRDTstE4-B1Y3MmBlhuxLeHQ~0a2G2K4aijuK2ZKjQh4UopLohMsbIHO4ULYs5oKO2CBI4oVfw__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA' },
        { id: 5, category: 2, title: 'הפסח האחרון בגטו וארשה', storyImg: 'https://s3-alpha-sig.figma.com/img/e0a3/df00/82fa5f5578a40b43ca5f5f121a52dc3a?Expires=1618185600&Signature=Wslmmqy1xd5ncNgIW3Lr8Ber34BmqgLmtgMmZahV5wY18TA2w5CD9xtdK~-wLvOLA89MXWx-zuIzTLvrIEqvsFzXrrnJhU6F77ZUWB6jp4oDxDNbnrOigetGITsPMhlpl18YZx1Hi~lKNToFzeYSSU9IbqoHo7Lx0BF47foDvvBnAkuD15TCrKcgxJLGYRpwCXrO5ajpHEmpQ~uuwRFEj30rDW9VSndNSm6C~Arf1TLBCgq4uZLcxnHSP7ks4GyXNXO8z706-n4gzeQDQGZeWqI6~d-jtwlXmil-nqxxD9P9M01GSqCi0lmlKMPMnlAZxu4d20VNQI6Ldf0f5yls9A__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA' },
        { id: 6, category: 1, title: 'פסח האחרון', storyImg: 'https://s3-alpha-sig.figma.com/img/e0a3/df00/82fa5f5578a40b43ca5f5f121a52dc3a?Expires=1617580800&Signature=KYlP3GTFcuZmK8LSLAYhksfXwZWkMBItgU81gW9MmkJpNMSdPXzTHtkpXMT7QqyqJWoE~b0vqVQuapn~naWSXUgHDRzjvUx5Ych3grC4qVpPAvFReftVROhKuruvSRPGHqtaO32C7~WuaCUa~Rq4JXm0y-yabJy9hYOz0KfzGJd6BgxuSkkfefqtdPYBQsAvmqSrtgwX5a5GdBlTE61M9QL7EMphbpkb1XRyxy11d6jiMB4qdEK-qAC-Odhzxt68c77xwcODTcIF3-agXtcU3bWlVZhP8p3wH~c6vEGGXm68txwg0roLNLJxpnt-mVAHQdCvgjOKhq6aFg1sGEpysw__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA' }
...
class StoryCheck extends React.Component {
    ...
    handleCategoryChosen = (categoty) => {
        const newStories = categoty.id === 0 ? mock : mock.filter((story) => categoty.id === story.category);

        this.setState({stories: newStories, category: categoty});
    }
            ...
            <div className='storyCheck-container'>
                ...
                <div className='categories'>
                    ...
                    {categories.map((categoty, index) => {
                        return (
                            <button className='category' key={index} onClick={() => this.handleCategoryChosen(categoty)}>{categoty.name}</button>
                        )
                    })
                    }
                </div>
